...
public:
    ...
    void                PSO_topology_evolution(vector<vec> &velocities, Data_set data_set, net_topology max_topo, vector<NeuralNet> &pBest, NeuralNet gBest, double pop_score_variance, mat& results_score_evolution, unsigned int gen);
